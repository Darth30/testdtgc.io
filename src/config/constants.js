// ═══════════════════════════════════════════════════════════════
//                    DTGC TESTNET CONFIGURATION V19
//                    (Fork of Mainnet - FAKE MONEY ONLY)
//                           testdtgc.io
//
//        ⚠️  NO REAL TRANSACTIONS - SIMULATION ONLY  ⚠️
//
// ═══════════════════════════════════════════════════════════════
...
export const TESTNET_MODE = true;   // ⚠️ TESTNET - Fake money only!
export const VIDEOS_ENABLED = true;
export const PASSWORD_PROTECTED = false;  // No password for testnet
export const SITE_PASSWORD = '';


// ═══════════════════════════════════════════════════════════════
//                    TESTNET FAKE BALANCES
// ═══════════════════════════════════════════════════════════════

export const FAKE_BALANCES = {
  dtgc: 1000000,      // 1M fake DTGC
  urmom: 500000,      // 500K fake URMOM
  pls: 100000,        // 100K fake PLS
  lpDtgcPls: 50000,   // 50K fake LP
  lpDtgcUrmom: 25000, // 25K fake LP
};
...
export const FAKE_STAKING_STATS = {
  totalStaked: 250000000,
  totalStakers: 1247,
  rewardsDistributed: 15000000,
};
